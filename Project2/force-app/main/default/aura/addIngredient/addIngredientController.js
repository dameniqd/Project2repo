({
    doInit : function(component, event, helper){
        ...
        //Create new request
         var drink = component.get('v.strIngredient');
        var data = null;
        ...
        xhr.addEventListener("readystatechange", function () {
            if (this.readyState === this.DONE) {
                ...
                component.set("{!v.idIngredient}", myobj.ingredients[0]["idIngredient"]);
                component.set("{!v.strIngredient}", myobj.ingredients[0]["strIngredient"]);
                component.set("{!v.strType}", myobj.ingredients[0]["strType"]);
            }});
